...
fig = px.treemap(df_tree, path=[px.Constant("MAU"),'Region','Localidad','Organización_Huerta_Colectivo'], values = 'Personas', title = 'Distribución de las Personas representantes por Regiones, Localidades y Organizaciones, Huertas y/o Comunidades')
